...
<script>
  document.addEventListener("DOMContentLoaded", () => {
    const t = document.getElementById("card-description");
    if (t && t.innerText.length > 30) {
      t.textContent = t.innerText.substring(0, 30) + "…";
    }
  });
</script>
