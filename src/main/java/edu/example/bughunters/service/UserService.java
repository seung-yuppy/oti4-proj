...
public class UserService {
	...
	@Transactional
	public void signUp(String email, String rawPassword, String nickName, String baseAddr, String detailAddr,
			String extraAddr, String hasPet /* yes/no */) {
		...
		if (StringUtils.hasText(baseAddr))
			addr.append(baseAddr);
		if (StringUtils.hasText(detailAddr))
			addr.append(" ").append(detailAddr);
		if (StringUtils.hasText(extraAddr))
			addr.append(" ").append(extraAddr);
	...
	@Transactional
	public boolean updateProfile(Integer userId, String newPassword, String nickName, String baseAddr,
			String detailAddr, String extraAddr, String hasPet) {
	...
	public boolean resetPassword(String email, String newRawPassword) {
		...
		if (user == null)
			return false;
		String enc = encoder.encode(newRawPassword);
		return userDAO.updatePasswordByUserName(email, enc) == 1;
	}
